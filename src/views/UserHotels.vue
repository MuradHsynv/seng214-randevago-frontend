...
const fetchUserHotelsFromAPI = async (): Promise<Hotel[]> => {
  // Kullanıcının otellerini API'den çekmek için. Simülasyon:
  await new Promise(resolve => setTimeout(resolve, 700));
  return [
    { id: '101', name: 'Cozy User Hotel', description: 'Nice place for relaxing', location: 'Istanbul, Turkey', imageUrl: '', price: '150$', rating: 4 },
    { id: '102', name: 'Budget Inn', location: 'Ankara, Turkey', price: '80$', rating: 3 },
  ];
};
